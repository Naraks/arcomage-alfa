...
func update_ui() -> void:
	...
	match card_data.type:
		CardData.ResourceType.BRICKS: background.modulate = Color(0.8, 0.4, 0.4)
		CardData.ResourceType.GEMS: background.modulate = Color(0.4, 0.4, 0.8)
		CardData.ResourceType.BEASTS: background.modulate = Color(0.4, 0.8, 0.4)
