...
1. **Строительная победа:** своя Башня достигла высоты 65.
...
Каждый бой — самодостаточная партия: Башня, Стена, ресурсы и уровни генераторов **всегда сбрасываются к базовым значениям** (25 / 8 / по 5 / уровень 1) в начале боя, в бою на карте мира, в элитном бою, в бою с боссом и в Быстром бою одинаково. Это принципиально, потому что в игре есть условие «построй Башню до 65» — если бы Стена/Башня переносились между боями как «здоровье» (по аналогии с *Slay the Spire*), первая же строительная победа делала бы все следующие бои забега тривиальными.
