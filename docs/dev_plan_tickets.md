...
> `test_build_starting_run_deck_survives_initial_draw`. Не проверено вживую: сам факт, что колода в начале
> боя теперь выглядит нормально (⁓10 карт после раздачи, а не 1).
