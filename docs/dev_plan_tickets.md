...
>
> **Не проверено вручную** (нет доступа к редактору Godot из песочницы): реальный визуальный вид экрана, клик по кнопкам «Выбрать» в живой сцене, переход туда-обратно между картой мира и Отдыхом на реальном забеге, действительно ли бонус ощущается в следующем бою.
