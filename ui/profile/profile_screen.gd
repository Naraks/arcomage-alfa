extends Control
## ARC-046, UI 03/13 (#98): единая оболочка профиля по рекомендованному
## варианту docs/ui_screen_design_review.html «Единая оболочка».
## Фон, профиль, Слава, прогресс коллекции, возврат и навигация принадлежат
## этому экрану; три существующие сцены работают внутри него без своих shell.
