...
> ⚠️ Частично реализовано: `@export var max_hand_size: int = 5` в `data/resources/player_data.gd`.
...
> прежних 6/5.
>
> Не проверено вживую из песочницы (нет Godot) — нужно прогнать GUT и визуально проверить полную руку
> (5+ карт) в редакторе, включая случай с будущим артефактом «Книга Мудрости» (ARC-034, увеличивает
> `max_hand_size`), когда он появится.
