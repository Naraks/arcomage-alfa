...
const STARTER_DECK_CARD_PATHS := [
	"res://data/cards/bricks_wall.tres",
	"res://data/cards/beasts_knight.tres",
	"res://data/cards/bricks_quarry.tres",
...
const ALL_CARD_PATHS := [
	...
	"res://data/cards/bricks_quarry.tres",
	"res://data/cards/bricks_brick_factory.tres",
	"res://data/cards/bricks_medium_wall.tres",
	"res://data/cards/bricks_fortification.tres",
	"res://data/cards/bricks_siege_engine.tres",
	"res://data/cards/bricks_large_brick_factory.tres",
	"res://data/cards/bricks_fortress_wall.tres",
	"res://data/cards/bricks_drill.tres",
	"res://data/cards/bricks_great_wall.tres",
	"res://data/cards/bricks_foundation.tres",
	"res://data/cards/bricks_battering_ram.tres",
	"res://data/cards/bricks_repair.tres",
	"res://data/cards/bricks_deep_quarry.tres",
	"res://data/cards/bricks_catapult.tres",
	"res://data/cards/bricks_reserves.tres",
	"res://data/cards/bricks_dwarven_mine.tres",
	"res://data/cards/bricks_donjon.tres",
	"res://data/cards/bricks_siege_tower.tres",
	"res://data/cards/bricks_city_siege.tres",
	"res://data/cards/bricks_imperial_quarry.tres",
	...
	"res://data/cards/gems_meteorite.tres",
	"res://data/cards/gems_energy_shield.tres",
	"res://data/cards/gems_magic_bolt.tres",
	"res://data/cards/gems_armageddon.tres",
	"res://data/cards/gems_ice_arrow.tres",
	"res://data/cards/gems_spark_of_fury.tres",
	"res://data/cards/gems_clairvoyance.tres",
	"res://data/cards/gems_quarry_corruption.tres",
	"res://data/cards/gems_curse.tres",
	"res://data/cards/gems_essence_theft.tres",
	"res://data/cards/gems_dungeon_corruption.tres",
	"res://data/cards/gems_archmage.tres",
	"res://data/cards/gems_foundation_destruction.tres",
	"res://data/cards/gems_great_curse.tres",
	"res://data/cards/gems_time_theft.tres",
	"res://data/cards/gems_archmagisterium.tres",
	"res://data/cards/gems_absolute_cataclysm.tres",
	"res://data/cards/beasts_hunter.tres",
	"res://data/cards/beasts_hunting_lodge.tres",
	"res://data/cards/beasts_goblin.tres",
	"res://data/cards/beasts_beast_farm.tres",
	"res://data/cards/beasts_dragon.tres",
	"res://data/cards/beasts_militia.tres",
	"res://data/cards/beasts_wolf_pack.tres",
	"res://data/cards/beasts_beast_kennel.tres",
	"res://data/cards/beasts_griffin.tres",
	"res://data/cards/beasts_guard.tres",
	"res://data/cards/beasts_wild_hounds.tres",
	"res://data/cards/beasts_taming.tres",
	"res://data/cards/beasts_defensive_pack.tres",
	"res://data/cards/beasts_orc.tres",
	"res://data/cards/beasts_wyvern.tres",
	"res://data/cards/beasts_vampire.tres",
	"res://data/cards/beasts_alpha_den.tres",
	"res://data/cards/beasts_troll.tres",
	"res://data/cards/beasts_hydra.tres",
	"res://data/cards/beasts_ancient_leviathan.tres",
	"res://data/cards/beasts_ancients_den.tres",
	"res://data/cards/beasts_goliath.tres",
]
...
func _initialize_test_deck() -> void:
	...
	push_warning(
		"MatchManager: колода забега исчерпана, докладываю запасной пул (%d карт)" % deck.size()
	)
